...
if __name__ == '__main__':
    ...
    writer.writerow(['input', 'sat', 'output', 'runtime', 'variables', 'original', 'learned', 'agility', 'level', 'used', 'conflicts', 'limit', 'mb', 'r_sum'])
    ...
    for i in range(1, 1+inputfilelength):
        ...
        proc = subprocess.Popen(["python", "-c", "import webber; webber.solve_string(%s)"%(inputfilestring)], stdout=subprocess.PIPE)
